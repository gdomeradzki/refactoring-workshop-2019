...
bool Controller::foodHandler(auto requestedFood)
{
...
void Controller::checkSelfSnakeCollision(Segment newHead, bool& lost)
{
...
void Controller::receive(std::unique_ptr<Event> e)
{
    try {
        ...
        checkSelfSnakeCollision(newHead, lost);
        ...
        try {
            ...
            try {
                ...
                bool requestedFoodCollidedWithSnake = foodHandler(receivedFood);
                ...
                try {
                    ...
                    bool requestedFoodCollidedWithSnake = foodHandler(requestedFood);

...
void Controller::foodHandler(std::unique_ptr<Event> e)
{
...
void Controller::checkForSelfCollision(bool lost, Segment newHead)
{
...
void Controller::receive(std::unique_ptr<Event> e)
{
    try {
        ...
        checkForSelfCollision(lost, newHead);

...
void Controller::handlePause(const PauseInd& paused)
{
    paused = true;
}
...
void Controller::receive(std::unique_ptr<Event> e)
{
    switch(e->getMessageId())
    {
        ...
        case DirectionInd::MESSAGE_ID: if (!paused) { return handleDirectionChange(*static_cast<EventT<DirectionInd> const&>(*e)); }

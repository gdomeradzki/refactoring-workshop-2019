...
void Controller::requestedFoodEvent(auto& requestedFood, bool& requestedFoodCollidedWithSnake)
{
...
void Controller::checkFoodColision(Segment newHead, bool& lost)
{
    if (not lost) {
...
void Controller::receive(std::unique_ptr<Event> e)
{
    try {
      ...
      //  Controller::checkFoodColision(newHead, lost);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    requestedFoodEvent(requestedFood, requestedFoodCollidedWithSnake);

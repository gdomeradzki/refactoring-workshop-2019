      ...
      m_paused(false)
{
    ...
    m_segments = std::make_unique<Segments>(displayPort,scorePort,foodPort,readDirection(istr));
...
//{
//    if (m_segements->isCollision(position) or not m_world->contains(position)) {
...
void Controller::handleTimeoutInd()
{
   ...
   m_segments -> updateSegmentsIfSuccessfullMove(newHead, m_world->getFoodPosition());
}

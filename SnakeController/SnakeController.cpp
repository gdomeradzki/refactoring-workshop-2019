...
bool SnakeHandler::isSegmentAtPosition(int x, int y) const
{
...
void FoodHandler::sendClearOldFood()
{
...
bool perpendicular(Direction dir1, Direction dir2)
{
    ...
    SnakeHandler::Segment SnakeHandler::calculateNewHead() const
{
...
void SnakeHandler::removeTailSegment()
{
...
void SnakeHandler::addHeadSegment(Segment const& newHead)
{
...
void SnakeHandler::removeTailSegmentIfNotScored(Segment const& newHead)
{
...
void SnakeHandler::updateSegmentsIfSuccessfullMove(Segment const& newHead)
{
...
void FoodHandler::updateFoodPosition(int x, int y, std::function<void()> clearPolicy)
{

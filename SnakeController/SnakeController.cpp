        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    requestedFoodHandler(requestedFood);
                } catch (std::bad_cast&) {
...
void Controller::timeEventHandler(const auto& timerEvent)
{
...
void Controller::requestedFoodHandler(const auto& requestedFood)
{
    bool requestedFoodCollidedWithSnake = false;
    for (auto const& segment : m_segments) {
...
void Controller::placeNewFood(const auto& food)
{

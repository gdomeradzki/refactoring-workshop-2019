      ...
      m_paused(false)
{
    ...
    if (w == 'W' and f == 'F' and s == 'S') {
        ...
        map.setFoodPosition(std::make_pair(foodX, foodY));
...
{
    map.setFoodPosition(std::make_pair(x, y));
...
void Controller::sendClearOldFood()
{
    ...
    clearOldFood.x = map.getFoodPosition().first;
    clearOldFood.y = map.getFoodPosition().second;

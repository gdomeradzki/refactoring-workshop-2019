...
void World::setMapDimension(std::pair<int, int> newMap)
{
    m_mapDimension = newMap;
}
std::pair<int, int> World::getFoodPosition()
{
    return m_foodPosition;
}
void World::setFoodPosition(std::pair<int, int> newFood)
{
...
Snake::Segment SnakeClass::calculateNewHead() const
{
